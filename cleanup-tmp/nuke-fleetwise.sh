#!/bin/bash
# This is a temporary script that helps with removing all fleetwise resources upon transitioning from Gamma to prod.
# This script will be removed before making the repository public.
# Currently we should keep it because we need it in order to cleanly redeploy our personal accounts and biga-dev.
